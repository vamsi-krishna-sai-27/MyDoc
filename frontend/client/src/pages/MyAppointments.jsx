    ...
    <div className='ml-25 mr-25'>
        ...
        <div>
            {doctors.slice(0,3).map((item,index)=>(
                <div className='grid grid-cols-[1gr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-gray-200'  key={index}>
                    <div>
                    ...
                    <div className='flex-1 text-sm text-zinc-600'>
                        ...
                        <p className='text-xs'>{item.address.line1}</p>
                        <p className='text-xs mt-1'><span className='text-sm text-netural-700 font-medium'>Date & Time:</span>25,july,2024 |8:30</p>
                    </div>
                    <div></div>
                    <div className='flex flex-col gap-2 justify-end'>
                        ...
                        <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border'>Cancel appointment</button>
                    </div>
                </div>
            ))}
        </div>
